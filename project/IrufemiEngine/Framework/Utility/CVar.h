...
public:
    ...
    static void RegisterString(const std::string& name, const std::string& defaultValue, const std::string& description);
...
#define DEFINE_CVAR_INT(name, defaultValue, description) \
    namespace { struct MACRO_CONCAT(CVarReg_, __LINE__) { \
        MACRO_CONCAT(CVarReg_, __LINE__)() { Irufemi::CVarSystem::RegisterInt(name, defaultValue, description); } \
    } MACRO_CONCAT(cvarInst_, __LINE__); }

#define DEFINE_CVAR_FLOAT(name, defaultValue, description) \
    namespace { struct MACRO_CONCAT(CVarReg_, __LINE__) { \
        MACRO_CONCAT(CVarReg_, __LINE__)() { Irufemi::CVarSystem::RegisterFloat(name, defaultValue, description); } \
    } MACRO_CONCAT(cvarInst_, __LINE__); }

#define DEFINE_CVAR_BOOL(name, defaultValue, description) \
    namespace { struct MACRO_CONCAT(CVarReg_, __LINE__) { \
        MACRO_CONCAT(CVarReg_, __LINE__)() { Irufemi::CVarSystem::RegisterBool(name, defaultValue, description); } \
    } MACRO_CONCAT(cvarInst_, __LINE__); }

#define DEFINE_CVAR_STRING(name, defaultValue, description) \
    namespace { struct MACRO_CONCAT(CVarReg_, __LINE__) { \
        MACRO_CONCAT(CVarReg_, __LINE__)() { Irufemi::CVarSystem::RegisterString(name, defaultValue, description); } \
    } MACRO_CONCAT(cvarInst_, __LINE__); }
