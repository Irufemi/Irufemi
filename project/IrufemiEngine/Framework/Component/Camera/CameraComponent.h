...
public:
     ...
     */
    void SetPositionOffset(const Irufemi::Vector3& offset) { positionOffset_ = offset; }
    
    /**
     * @brief 演出用の一時的な回転オフセットを設定します
     */
    void SetRotationOffset(const Irufemi::Vector3& offset) { rotationOffset_ = offset; }

    Irufemi::Vector3 GetPositionOffset() const { return positionOffset_; }
    Irufemi::Vector3 GetRotationOffset() const { return rotationOffset_; }
