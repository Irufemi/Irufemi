...
public:
    ...
    std::string GetComponentName() const override { return "SpawnPointComponent"; }
    ...
    // Getter / Setter
    const std::string& GetWaveId() const { return waveId_; }
    void SetWaveId(const std::string& id) { waveId_ = id; }
