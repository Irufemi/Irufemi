...
void SpriteRendererComponentEditor::Draw(Component* component, EditorActionManager* actionManager) {
    ...
    if (headerOpen) {
        if (ComponentUIHelpers::BeginPropertyTable("SpriteRendererTable")) {
            ...
            ComponentUIHelpers::DrawPropertyResetButton("##TexReset", !comp->texturePath_.empty() && comp->texturePath_ != "whiteTexture.png", [&]() {
                std::string oldTex = comp->texturePath_;
            ...
            ComponentUIHelpers::DrawPropertyResetButton("##TopMostReset", isTopMost, [&]() {
                ...
                ComponentUIHelpers::PushInstantUndo(actionManager, oldTopMost, false, std::function<void(const bool&)>([comp](const bool& v){ comp->isTopMost_ = v; if (comp->GetSprite()) comp->GetSprite()->SetTopMost(v); }));
            });
            ...
            ComponentUIHelpers::DrawPropertyResetButton("##FlipXReset", isFlipX, [&]() {
                ...
                ComponentUIHelpers::PushInstantUndo(actionManager, oldFlipX, false, std::function<void(const bool&)>([comp](const bool& v){ comp->isFlipX_ = v; if (comp->GetSprite()) comp->GetSprite()->SetFlip(comp->isFlipX_, comp->isFlipY_); }));
            });
            ...
            ComponentUIHelpers::DrawPropertyResetButton("##FlipYReset", isFlipY, [&]() {
                ...
                ComponentUIHelpers::PushInstantUndo(actionManager, oldFlipY, false, std::function<void(const bool&)>([comp](const bool& v){ comp->isFlipY_ = v; if (comp->GetSprite()) comp->GetSprite()->SetFlip(comp->isFlipX_, comp->isFlipY_); }));
            });
