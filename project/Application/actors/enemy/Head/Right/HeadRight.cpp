...
void HeadRight::SetTransform(const Transform& transform, const Vector3* drawWorldPos) {
  if (!isBlownAway_) {
...
void HeadRight::OnDestroyed(const Vector3& attackDir, float blowSpeed) {
...
bool HeadRight::IsCompletelyDead() const {
